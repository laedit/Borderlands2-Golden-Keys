...
namespace Borderlands2GoldendKeys.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IDocumentSession documentSession)
        {
            ...
            UserManager = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(() => this._documentSession));
        }
        ...
        private bool IsThereAlreadyAUser()
        {
            return _documentSession.Query<ApplicationUser>().Any();
        }
